  ...
  const result = await pool.request()
    ...
    .query(`
      SELECT
        ...
        SUM(CASE WHEN aa.status = 'ASSIGNED_TO_LEADER' THEN 1 ELSE 0 END) AS undistributed,
        SUM(CASE WHEN aa.status <> 'ASSIGNED_TO_LEADER' THEN 1 ELSE 0 END) AS distributed,
